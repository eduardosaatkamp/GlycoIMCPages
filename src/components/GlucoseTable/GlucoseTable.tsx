...
const GlucoseTable = () => {
  ...
  const pacientes: Paciente[] = [
    ...
    { nome: 'Ana Souza', glicemia: 110, descricao: 'Pré-diabetes (100-125)', obsGlicemia: `${t('observation.preDiabetes')} - ${t('observation.requiresAttention')}` },
    { nome: 'João Pereira', glicemia: 130, descricao: 'Diabetes (>125)', obsGlicemia: `${t('observation.diabetes')} - ${t('observation.requiresAttention')}` },
  ];
  ...
  return (
    <Card>
      ...
      <Description>
        ...
        um período de jejum de 8 horas ou mais. Valores normais estão entre <strong>70 e 99 mg/dL</strong>. 
        Atenção para valores abaixo de 70 (hipoglicemia) ou acima de 125 (diabetes).
      </Description>
      <Table>
        <thead>
          <tr>
